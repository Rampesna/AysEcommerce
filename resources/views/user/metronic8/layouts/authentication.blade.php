...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('user/' . $options->theme . '/assets/media/logos/favicon.ico') }}" />
...
<div class="d-flex flex-column flex-root">
    <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{ asset('user/' . $options->theme . '/media/illustrations/development-hd.png') }})">
        @yield('content')
    </div>
</div>
