    ...
    <div class="hover-scroll-overlay-y my-2 my-lg-5 pe-lg-n1" id="kt_aside_menu_wrapper">
        <div class="menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold" id="#kt_aside_menu" data-kt-menu="true">
            <div class="menu-item py-2">
                <a href="{{ route('user.dashboard.index') }}" class="menu-link {{ request()->segment(2) === 'dashboard' ? 'active' : '' }} menu-center">
                    <span class="menu-icon me-0">
                        <i class="bi bi-house fs-2"></i>
                    </span>
                    <span class="menu-title">{{ __('user/aside.dashboard') }}</span>
                </a>
            </div>
            <div class="menu-item py-2">
                <a href="{{ route('user.order.index') }}" class="menu-link {{ request()->segment(2) === 'order' ? 'active' : '' }} menu-center">
                    <span class="menu-icon me-0">
                    ...
                    <span class="menu-title">{{ __('user/aside.order') }}</span>
                </a>
            </div>
            <div class="menu-item py-2">
                <a href="{{ route('user.product.index') }}" class="menu-link {{ request()->segment(2) === 'product' ? 'active' : '' }} menu-center">
                    <span class="menu-icon me-0">
                    ...
                    <span class="menu-title">{{ __('user/aside.product') }}</span>
                </a>
            </div>
            <div class="menu-item py-2">
                <a href="{{ route('user.marketing.index') }}" class="menu-link {{ request()->segment(2) === 'marketing' ? 'active' : '' }} menu-center">
                    <span class="menu-icon me-0">
                        <span class="svg-icon svg-icon-muted svg-icon-2hx">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <span class="menu-title">{{ __('user/aside.marketing') }}</span>
                </a>
            </div>
            <div class="menu-item py-2">
                <a href="{{ route('user.customer.index') }}" class="menu-link {{ request()->segment(2) === 'customer' ? 'active' : '' }} menu-center">
                    <span class="menu-icon me-0">
                        <span class="svg-icon svg-icon-muted svg-icon-2hx">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <span class="menu-title">{{ __('user/aside.customer') }}</span>
                </a>
            </div>
            <div class="menu-item py-2">
                <a href="{{ route('user.report.index') }}" class="menu-link {{ request()->segment(2) === 'report' ? 'active' : '' }} menu-center">
                    <span class="menu-icon me-0">
                        <span class="svg-icon svg-icon-muted svg-icon-2hx">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <span class="menu-title">{{ __('user/aside.report') }}</span>
                </a>
            </div>
            <div class="menu-item py-2">
                <a href="{{ route('user.setting.index') }}" class="menu-link {{ request()->segment(2) === 'setting' ? 'active' : '' }} menu-center">
                    <span class="menu-icon me-0">
                        <span class="svg-icon svg-icon-muted svg-icon-2hx">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <span class="menu-title">{{ __('user/aside.setting') }}</span>
                </a>
            </div>
        </div>
    </div>
